...
import {RelayRouter_NonTstore} from "../src/v2/RelayRouter_NonTstore.sol";

contract RelayRouter_NonTstoreV2Deployer is Script {
    ...
    function run() public {
        ...
        RelayRouter_NonTstore relayRouter = RelayRouter_NonTstore(
            payable(deployRelayRouter())
        );
    ...
    function deployRelayRouter() public returns (address) {
        ...
        // Deploy
        RelayRouter_NonTstore relayRouter = new RelayRouter_NonTstore{
            salt: SALT
        }();
